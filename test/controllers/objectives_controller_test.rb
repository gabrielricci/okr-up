...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { description: @objective.description, organization_id: @objective.organization_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { description: @objective.description, organization_id: @objective.organization_id } }
